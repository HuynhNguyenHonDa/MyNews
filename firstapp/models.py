...
class StoriesCategory(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'stories_category'


class StoriesContact(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'stories_contact'


class StoriesStory(models.Model):
    name = models.CharField(unique=True, max_length=250)
    author = models.CharField(max_length=250)
    url = models.CharField(max_length=200, blank=True, null=True)
    content = RichTextUploadingField()
    public_day = models.DateField(auto_now_add=True)
...
class StoriesSubcribe(models.Model):
    email = models.CharField(max_length=254)
    subcribe_day = models.DateField()

    class Meta:
        managed = False
        db_table = 'stories_subcribe'
